	...
	void Update (){
		...
		if (menu.Getstart() == true) {
			...
			if (score < 50) {
				...
				GameObject.Find ("generationtrack").GetComponent<generation> ().difficulty (Maxspawntime - 10, CarMoveSpeed, MaxCoinIngame, MaxCoinSpawnTime, numberOfCar);
				...
				GameObject.Find ("generationtrack").GetComponent<generation> ().difficulty (Maxspawntime - 20, CarMoveSpeed + 0.05f, MaxCoinIngame, MaxCoinSpawnTime, numberOfCar);
				GameObject.Find ("thief").GetComponent<autojump2> ().geMaxJumpCd (7);
				...
				GameObject.Find ("generationtrack").GetComponent<generation> ().difficulty (Maxspawntime - 30, CarMoveSpeed + 0.05f, MaxCoinIngame, MaxCoinSpawnTime, numberOfCar + 1);
				GameObject.Find ("thief").GetComponent<autojump2> ().geMaxJumpCd (6);
			}
			if (score >= 400 && score < 700) {
				...
				GameObject.Find ("generationtrack").GetComponent<generation> ().difficulty (Maxspawntime - 35, CarMoveSpeed + 0.05f, MaxCoinIngame, MaxCoinSpawnTime, numberOfCar + 1);
				GameObject.Find ("thief").GetComponent<autojump2> ().geMaxJumpCd (5);
			}
			if (score >= 700) {
				...
				GameObject.Find ("generationtrack").GetComponent<generation> ().difficulty (Maxspawntime - 50, CarMoveSpeed + 0.1f, MaxCoinIngame, MaxCoinSpawnTime, numberOfCar + 2);
				GameObject.Find ("thief").GetComponent<autojump2> ().geMaxJumpCd (4);
			}
